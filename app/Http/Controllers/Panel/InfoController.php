...
use App\Models\{Question, Answer, Industry, UserInformation, User};
use Auth;
use Validator;
use Redirect;
    ...
    public function getProfile($id)
    {
        ...
        if ($questions != null) {
            foreach ($questions as $question) {
                ...
                $data[] = array(
                    'id' => $question->id, 'questions' => $question->question, 'type' => $question->type, 'answers' => $answers
                );
                $answers = null;
            }
