...
<template>
    <div class="app-sidebar flex-column" :style="`left: ${sidebar ? '0px' : 'calc(0px - var(--kt-app-sidebar-width))'
        ...
        <div class="app-sidebar-logo px-6" style="border-bottom: 1px solid rgb(64, 64, 64); height: 70px">
            ...
            <button @click="() => this.$emit('toggleSidebar')"
                ...
                :style="`top: 28px; left: ${!sidebar
        ? 'calc(10px + var(--kt-app-sidebar-width))'
        : '100%'
        }; `">
                <span style="transition: 0.4s all ease" :class="`svg-icon svg-icon-2 ${!sidebar && 'rotate-180'}`">
        ...
        <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
            <div class="app-sidebar-wrapper">
                <div class="overflow-auto customscrollbar m-0 h-600px">
                    <div class="menu menu-column menu-rounded menu-sub-indention px-3">
                        <div class="menu-item m-0" v-for="(navigation, index) in navigations" :key="index">
                            <Link :class="` ${navigation.route === route().current()
        ? 'menu-link m-0 active'
        : 'menu-link m-0'
            ...
            <form method="post" @submit.prevent="logout">
                <button type="submit"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#ffffff"
                        width="14" height="14" version="1.1" id="Capa_1" viewBox="0 0 384.971 384.971"
                        xml:space="preserve">
                        <g>
                            <g id="Sign_Out">
                                <path
