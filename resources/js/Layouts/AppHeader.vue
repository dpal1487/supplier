        ...
        >
            ...
            >
                ...
                <div class="app-navbar flex-shrink-0">
                    <div
                        @mouseleave="toggleThemeModeDrop(false)"
                        @mouseenter="toggleThemeModeDrop(true)"
                        ...
                        >
                            <div class="menu-item px-3 my-0">
                                <button
                                    ...
                                    :class="`menu-link w-100 border-0 px-3 py-2 bg-transparent ${
                                        theme === 'light' && 'active'
                                    }`"
                    ...
                    <div class="app-navbar-item ms-1 ms-md-3">
                        ...
                        <div
                            aria-labelled:by="dropdown-profile"
                        ...
                        >
                            ...
                            <div class="menu-item px-5">
                                <form method="post" @submit.prevent="logout">
                                    <button
                                        type="submit"
                                        class="menu-link px-5 w-100"
                                    >
                                        <span class="btn-label me-3"
                                            >Logout</span
                                        >
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
