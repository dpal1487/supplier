        ...
        " class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-30px h-30px w-md-40px h-md-40px position-relative">
                        ...
                        <div v-if="themeModeDrop"
                            ...
                            <div class="menu-item px-3 my-0">
                                <button @click="handleThemeChange('light')" :class="`menu-link w-100 border-0 px-3 py-2 bg-transparent ${theme === 'light' && 'active'
                            ...
                            <div class="menu-item px-3 my-0">
                                <button @click="handleThemeChange('dark')" :class="`menu-link w-100 border-0 px-3 py-2 bg-transparent ${theme === 'dark' && 'active'
                            ...
                            <div class="menu-item px-3 my-0">
                                <button @click="handleThemeChange('system')" :class="`menu-link w-100 border-0 px-3 py-2 bg-transparent ${theme === 'system' && 'active'
                                ...
                                <div class="menu-content d-flex align-items-center px-3">
                                    ...
                                    <div class="d-flex flex-column">
                                        <div class="fw-bold d-flex align-items-center fs-5">
                                            {{ $page.props.ziggy?.user.supplier_name }}
                                            <span
                                                class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">Pro</span>
                                        </div>

                                        <a href="#" class="fw-semibold text-muted text-hover-primary fs-7">
                                            {{ $page.props.ziggy?.user.email_address }}
                                        </a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <form method="post" @submit.prevent="logout">
                                    <button type="submit" class="menu-link px-5 w-100">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" fill="#000000" width="14"
                                            height="14" version="1.1" id="Capa_1" viewBox="0 0 384.971 384.971"
                                            xml:space="preserve">
                                            <g>
                                                <g id="Sign_Out">
                                                    <path
