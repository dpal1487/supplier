...
<template>
    <app-layout :title="title">
        ...
        <div class="card">
            ...
            >
                <div
                    class="d-flex align-items-center position-relative w-100 mw-200px"
                >
                            ...
                            >
                                ...
                                <td>
                                    <span
                                        ...
                                        v-if="invoice?.is_gst_paid == 2"
                                        >Paid</span
                                    >
                                    <span
                                        class="badge badge-light-warning"
                                        v-if="invoice?.is_gst_paid == 0"
                                        >Unpaid</span
                                    >
                                </td>
                                <td>
                                ...
                                <td>
                                    <a
                                        href="#"
                                        class="btn btn-sm btn-light menu-dropdown w-100px"
            ...
            <div class="card-footer">
                <div class="row" v-if="invoices.data.length > 0">
                    <div
                        class="col-sm-12 d-flex align-items-center justify-content-between"
                        v-if="invoices.meta"
                    >
                        <span class="fw-bold text-gray-700">
                            Showing {{ invoices.meta.from }} to
                            {{ invoices.meta.to }} of
                            {{ invoices.meta.total }} entries
                        </span>
