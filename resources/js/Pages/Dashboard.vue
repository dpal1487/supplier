              ...
              <div class="table-responsive">
                <table class="table table-row-dashed align-middle">
                  ...
                  <tbody class="text-center">
                      ...
                      <td>
                            <span class="text-gray-600 fw-semibold d-block fs-7">{{ project?.project_id }}</span>
                      </td>
                      <td>
                        <span class="text-gray-600 fw-semibold d-block fs-7">{{ project?.project_name }}</span>
                      </td>
                      <td>
                        <span class="text-gray-600 fw-semibold d-block fs-7 text-capitalize">{{ project?.project_type }}</span>
                      </td>
                      <td>
                        <span
                      ...
                      <td>
                        <span class="text-gray-600 fw-semibold d-block fs-7">{{ project?.client?.name }}</span>
                      </td>
