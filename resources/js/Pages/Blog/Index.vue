...
<template>
    ...
    <app-layout :title="title">
        <template #breadcrumb>
            ...
            <li class="breadcrumb-item">
                <Link href="/blog" class="text-muted text-hover-primary">{{ title }}</Link>
            </li>
        </template>
        <template #toolbar>
        ...
        <div class="card">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5 text-left">
                        ...
                        <tbody class="fw-semibold text-gray-500" v-if="blogs.data.length > 0">
                            <tr v-for="(blog, index) in blogs.data" :key="index">
                                ...
                                <td class="w-650px" v-html="blog?.content"></td>
                                <td>
            ...
            <div class="card-footer">
                <div class="row" v-if="blogs.data.length > 0">
                    <div class="col-sm-12 d-flex align-items-center justify-content-between" v-if="blogs.meta">
                        <span class="fw-bold text-gray-700">
                            Showing {{ blogs.meta.from }} to
                            {{ blogs.meta.to }} of
                            {{ blogs.meta.total }} entries
                        </span>
