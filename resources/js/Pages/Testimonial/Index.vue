...
export default defineComponent({
    ...
    methods: {
        ...
        confirmDelete(id, index) {
            this.isLoading = true;
            const name = this.testimonials.data[index].name;
            Swal.fire({
                    ...
                    axios
                        ...
                        .then((response) => {
                            ...
                            if (response.data.success) {
                                this.testimonials.data.splice(index, 1);
                                return;
                            }
                        })
                        .catch((error) => {
            ...
            Inertia.get(
                ...
                this.form,
                {
                    preserveState: true, onSuccess: (data) => {
                        this.testimonial = data.props.testimonial;
                    },
                }
            );
        },
...
<template>
    <app-layout title="Testimonial">
        ...
        <div class="card card-flush">
            <div>
                <form class="card-header align-items-center py-5 gap-2" @submit.prevent="search()">
                    <!--begin::Card title-->
                    ...
                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                        ...
                        <Link href="/testimonial/create" class="btn btn-primary">
                        Add testimonial
                        </Link>
                        <!--end::Add industries-->
                                        ...
                                        <ul class="dropdown-menu text-small menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                            ...
                                            <li class="menu-item px-3">
                                                <Link
                                                    ...
                                                    :href="`/testimonial/${testimonial.id}/edit`">Edit
                                                </Link>
                                            </li>
                                            <li class="menu-item px-3">
                                                <Link
                                                    class="btn btn-sm dropdown-item align-items-center justify-content-center"
                                                    :href="`/testimonial/${testimonial.id}`">View
                                                </Link>
                                            </li>
