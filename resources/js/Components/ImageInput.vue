...
<template>
    <div class="d-flex align-items-center justify-content-between mx-10">
        <div class="text-center w-100">
            <div
                class="image-input image-input-outline mx-auto"
            ...
            >
                <div
                    class="mw-125px h-125px d-flex align-items-center justify-content-center rounded-1 bg-secondary"
                    v-if="isUploading"
                >
                    <div
                        class="spinner-border spinner-border-sm w-50px h-50px"
                    ></div>
                </div>
                <div v-else>
                    <img
                        class="image-input-wrapper w-100 h-auto"
